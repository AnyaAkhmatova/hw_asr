...
class LibrispeechDataset(BaseDataset):
    def __init__(self, part, data_dir=None, use_kaggle=False, *args, **kwargs):
    ...
    def _create_index(self, part):
        ...
        # print("fail: _load_part should not be used with librispeech, use data from kaggle")
        if self.use_kaggle:
            split_dir = "/kaggle/input/librispeech/" + part
        else:
